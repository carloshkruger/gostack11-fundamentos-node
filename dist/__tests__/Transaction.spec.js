...
describe('Transaction', function () {
    it('should be able to create a new transaction', function () { return __awaiter(_this, void 0, void 0, function () {
        var response;
    ...
    it('should be able to list the transactions', function () { return __awaiter(_this, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, supertest_1.default(app_1.default).post('/transactions').send({
    ...
    it('should not be able to create outcome transaction without a valid balance', function () { return __awaiter(_this, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, supertest_1.default(app_1.default).post('/transactions').send({
